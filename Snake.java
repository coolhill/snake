...
public class Snake extends JFrame {
	...
	/* Timer class is used to run the game and update it every
	   DELAY milliseconds. Used INSTEAD of runnable class and
	   threads. */
